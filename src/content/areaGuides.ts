export const areaGuideBodies: Record<string, string[]> = {
  ...
  "nc-aquarium": [
    "Located in Manteo, the North Carolina Aquarium on Roanoke Island is home to more than 2,000 animals across exhibits that trace the region's waters — from wild wetlands and sounds out to the \"Graveyard of the Atlantic,\" a large habitat featuring a replica of the Civil War ironclad USS Monitor. It's a great rainy-day or midday-heat option for families.",
    "Beyond the tanks, the aquarium runs daily programs like otter feedings and shipwreck talks, and its Sea Turtle Assistance and Rehabilitation (STAR) Center gives visitors a look at real sea turtle patients recovering before release. Entry is timed, so it's worth reserving tickets and checking current hours ahead of your visit, especially in peak season.",
  ],
